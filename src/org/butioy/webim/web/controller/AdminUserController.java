...
public class AdminUserController extends BaseController {
	...
	private final String LIST_ACTION = "redirect:/admin/user";
	...
	@ResponseBody
	public RespBean doEdit(ModelMap model,@PathVariable java.lang.Integer id,User user,BindingResult errors) throws Exception {
		RespBean result = new RespBean();
		try {
