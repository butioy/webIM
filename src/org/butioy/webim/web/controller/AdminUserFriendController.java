 ...
 */
@Controller
@RequestMapping("/admin/userFriend")
public class AdminUserFriendController extends BaseController {

	private static final Logger LOG = LoggerFactory.getLogger(AdminUserFriendController.class);

	@Autowired
	private IUserFriendService userFriendService;
	
	private final String LIST_ACTION = "redirect:/admin/userFriend";
	...
	public String edit(ModelMap model,@PathVariable java.lang.Integer id) throws Exception {
		...
		model.put("userFriend",userFriend);
		return "/admin/userFriend/edit";
	}
	
	/** 保存更新,@Valid标注spirng在绑定对象时自动为我们验证对象属性并存放errors在BindingResult  */
	@RequestMapping(value="/{id}/doEdit")
	@ResponseBody
	public RespBean doEdit(ModelMap model,@PathVariable java.lang.Integer id,UserFriend userFriend,BindingResult errors) throws Exception {
		RespBean result = new RespBean();
		try {
