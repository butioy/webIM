          ...
          <div class="col-md-12 form-horizontal">
            <form class="form-horizontal" id="edit_role_form">
              ...
              <div class="form-group">
                <label for="name" class="col-md-4 control-label">角色名称</label>
                <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <label>
                    <input type="radio" name="status" id="status_1" class="form-control" value="1" ${role.status eq 1 ? 'checked' : ''}>&nbsp;&nbsp;启用
                  </label>
                  <label style="margin-left: 30px;">
                    <input type="radio" name="status" id="status_0" class="form-control" value="0" ${role.status eq 0 ? 'checked' : ''}>&nbsp;&nbsp;禁用
                  </label>
                </div>
              </div>
            </form>
    ...
    <script>
      $(function() {
        ...
        $("#submitBtn").on("click", function() {
          ...
          var param = $("#edit_role_form").serialize();
          $.ajax({
            type:"post",
            url: "${ctx}/admin/auth/role/doEdit",
            data: param,
            dataType:"json",
