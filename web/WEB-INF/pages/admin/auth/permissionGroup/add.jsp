      ...
      <section class="content container">
        <div class="row">
          <div class="col-md-12 form-horizontal">
            <form class="form-horizontal" id="add_permission_group_form">
              <div class="form-group">
                <label for="name" class="col-md-4 control-label">权限组名称</label>
                <div class="col-md-8">
                  <input type="text" class="form-control" id="name" name="name" placeholder="权限组名称"/>
                </div>
              </div>
              <div class="form-group">
    ...
    <script>
      $(function() {
        ...
        $("#submitBtn").on("click", function() {
          ...
          var param = $("#add_permission_group_form").serialize();
          $.ajax({
            type:"post",
            url: "${ctx}/admin/auth/permissionGroup/doAdd",
            data: param,
            dataType:"json",
