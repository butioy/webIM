...
public class MD5EncryptUtils {
	...
	/**
	 * MD5_Encoding类提供的主要的接口函数getMD5ofStr，用来进行数据加密变换。调用其可对任意字符串进行加密运算，
	 * 并以字符串形式返回加密结果。
	 * 
	 * @param in
	 * @return
	...
	public static void main(String[] args) {
		MD5EncryptUtils util = new MD5EncryptUtils();
		System.out.println("md5En = " + util.getMD5ofStr("000000"));
